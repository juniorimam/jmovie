class ErrorPage extends HTMLElement {
  constructor() {
    ...
    this.innerHTML = `
      <h1 class="text-9xl text-white font-bold">${this.getAttribute("data-code")}</h1>
      <h1 class="text-2xl text-white font-bold">${this.getAttribute("data-message")}</h1>
      <p class="text-sm text-slate-500">${this.getAttribute("data-description")}</p>
      <a
        href="/"
