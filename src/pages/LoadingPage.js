class LoadingPage extends HTMLElement {
  constructor() {
    ...
    this.setAttribute(
      "class",
      "container flex flex-col justify-center items-center gap-1 min-w-full min-h-screen bg-slate-900"
    );
    ...
    this.innerHTML = `
      <div class="flex flex-row items-center -ml-5">
        ...
        <h1 class="text-4xl text-white font-bold ">JMovie</h1>
      </div>
      <p class="text-sm text-slate-500">Loading, please wait...</p>
    `;
  }
}
